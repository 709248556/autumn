      ...
      <Form :ref="formModal.formName"
        ...
        <Tabs v-model="formModal.selectTabValue">
          <TabPane label="基本信息"
            ...
            <FormItem :label="this.managerName + '代码：'"
                      prop="code">
              <Input v-model="formModal.formData.code"
                     placeholder="请输入代码" />
            </FormItem>
            <FormItem label="排序："
                      prop="sortId">
...
export default {
  name: 'tree-list-name-code-manager',
  components: {
    Action,
    TreeList,
    ExcelImport
  ...
  data () {
    return {
      ...
      treeColumns: [
        { title: this.managerName + '代码', key: 'code', minWidth: 155 },
        { title: '完整名称', key: 'fullName', minWidth: 160 },
        { title: '完整代码', key: 'fullCode', minWidth: 160 },
