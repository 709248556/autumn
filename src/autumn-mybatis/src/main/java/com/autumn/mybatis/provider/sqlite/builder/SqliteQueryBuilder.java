 ...
 * 2017-10-19 08:40:15
 */
public class SqliteQueryBuilder extends AbstractQueryBuilder {

    /**
     * @param dbProvider
     */
    public SqliteQueryBuilder(SqliteProvider dbProvider) {
        super(dbProvider);
    }
    ...
    private String getLimit(String parmaName) {
        ...
        sql.append("LIMIT #{" + pageClause + ".offset},#{" + pageClause + ".limit}");
        sql.append("</when>");
