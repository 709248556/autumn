 ...
 */
abstract class AbstractCriteria<TChildren extends AbstractCriteria<TChildren, TNameFunc>, TNameFunc>
     ...
     */
    protected AbstractCriteria(EntityTable entityTable, Function<TNameFunc, ColumnExpression> columnExpressionFunction) {
        super(entityTable);
     ...
     * @param criteriaBeans 条件 Beans 集合
     * @return
     */
    public <E extends CriteriaBean> TChildren criteria(LogicalOperatorEnum operater, List<E> criteriaBeans) {
     ...
     * @return
     */
    public <E extends CriteriaBean> TChildren criteria(List<E> criteriaBeans) {
     ...
     * @return
     */
    public TChildren nested(LogicalOperatorEnum logicalOperater, Function<CriteriaGroup<TChildren, TNameFunc>, CriteriaGroup<TChildren, TNameFunc>> func) {
        ExceptionUtils.checkNotNull(logicalOperater, "logicalOperater");
        ExceptionUtils.checkNotNull(func, "func");
        CriteriaGroup<TChildren, TNameFunc> children = func.apply(new CriteriaGroup<>(this.getEntityTable(), this.columnExpressionFunction));
        return children.addCriteria(this.returnThis(), logicalOperater);
    }
     ...
     * @return
     */
    public TChildren andNested(Function<CriteriaGroup<TChildren, TNameFunc>, CriteriaGroup<TChildren, TNameFunc>> func) {
        return this.nested(LogicalOperatorEnum.AND, func);
    }
     ...
     * @return
     */
    public TChildren orNested(Function<CriteriaGroup<TChildren, TNameFunc>, CriteriaGroup<TChildren, TNameFunc>> func) {
        return this.nested(LogicalOperatorEnum.OR, func);
    }
     ...
     * @return
     */
    public TChildren notNested(Function<CriteriaGroup<TChildren, TNameFunc>, CriteriaGroup<TChildren, TNameFunc>> func) {
        return this.nested(LogicalOperatorEnum.NOT, func);
    }
}
