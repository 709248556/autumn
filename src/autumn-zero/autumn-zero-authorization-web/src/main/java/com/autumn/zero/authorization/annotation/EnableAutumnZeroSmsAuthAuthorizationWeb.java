...
import com.autumn.zero.authorization.configure.AutumnZeroSmsAuthAuthorizationWebConfiguration;
...
@Import({AutumnZeroSmsAuthAuthorizationWebConfiguration.class})
...
public @interface EnableAutumnZeroSmsAuthAuthorizationWeb {
}
